...
import com.me.fanyin.zbme.views.main.view.adapter.AbsTipAdapter;
import com.me.fanyin.zbme.views.main.view.adapter.AddTipAdapter;
import com.me.fanyin.zbme.views.main.view.adapter.DragTipAdapter;
import com.me.fanyin.zbme.views.main.view.bean.Tip;
import com.me.fanyin.zbme.views.main.view.widget.DragDropGirdView;
import com.me.fanyin.zbme.views.main.view.widget.TipItemView;
...
public class EasyTipDragView extends RelativeLayout implements AbsTipAdapter.DragDropListener, TipItemView.OnDeleteClickListener,View.OnClickListener{
    ...
    private void initView(){
        ...
        //加载view
        View view  = LayoutInflater.from(getContext()).inflate(R.layout.maintype_view_easytagdrag,this);
