...
public final class DPTManager {
    ...
    /**
     * @see DPTheme#colorSelectedBGCircle()
     */
    public int colorSelectedBGCircle() {
        return theme.colorSelectedBGCircle();
    }
    ...
    /**
     * @see DPTheme#colorGDisenable()
     */
    public int colorGDisenable() {
        return theme.colorGDisenable();
    }
