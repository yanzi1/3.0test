...
public class SsubjectMuAdapter extends BaseAdapter {


    List<Ssubject> data;
    private CourseListActivity activity;

    public SsubjectMuAdapter(CourseListActivity activity) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        viewHolder.mText.setText(data.get(position).getsSubjectYear());
        if (activity.sSubjectPostion==position){
    ...
    public void setDatas(List<Ssubject> data){
        this.data = data;
    }
