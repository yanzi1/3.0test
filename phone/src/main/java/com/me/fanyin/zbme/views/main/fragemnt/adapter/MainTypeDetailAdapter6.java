 ...
 *  热门课程
 */
public class MainTypeDetailAdapter6 extends BaseQuickAdapter<MainDetailItemBean, BaseViewHolder> {
    private Context context;
    private List<MainDetailItemBean> data;
    private MainTypeAdapter.MainTypeItemClick mainTypeItemClick;
    private int mainPosition;

    public MainTypeDetailAdapter6(){
        super(R.layout.maintype_recycle_type3_item5);
    }

    public MainTypeDetailAdapter6(Context context, List<MainDetailItemBean> data, MainTypeAdapter.MainTypeItemClick mainTypeItemClick) {
        super(R.layout.maintype_recycle_type3_item5, data);
    ...
    protected void convert(final BaseViewHolder helper, final MainDetailItemBean item) {
        ...
        GlideIUtils.mainCommenGlid(context,item.getImage(),
                (ImageView) helper.getView(R.id.maintype_type3_item5_iv),
...
//                into((ImageView) helper.getView(R.id.maintype_type3_item5_iv));
        ...
        helper.setText(R.id.maintype_type3_item5_original_price_tv, "￥"+ StringUtils.formatPrice(Double.valueOf(item.getTab())));
