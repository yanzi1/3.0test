 ...
 */
package com.me.fanyin.zbme.widget.smarttablayout;
...
public class SmartTabLayout extends HorizontalScrollView {
    ...
    private ColorStateList tabViewTextColorsDefault;
    private ColorStateList tabViewTextColorsSelected;
    ...
    public SmartTabLayout(Context context, AttributeSet attrs, int defStyle) {
        ...
        ColorStateList textColorsDefault;
        ColorStateList textColorsSelected;
        ...
        textColorsDefault = a.getColorStateList(
                R.styleable.stl_SmartTabLayout_stl_defaultTabTextColor);
        textColorsSelected = a.getColorStateList(
        ...
        this.tabViewTextColorsDefault = (textColorsDefault != null)
                ? textColorsDefault
                : ColorStateList.valueOf(TAB_VIEW_TEXT_COLOR);
        this.tabViewTextColorsSelected = (textColorsSelected != null)
                ? textColorsSelected
                : ColorStateList.valueOf(TAB_VIEW_TEXT_COLOR);
     ...
     *
     * @param interpolator {@link com.me.fanyin.zbme.widget.smarttablayout.SmartTabIndicationInterpolator}
     */
    ...
    public void setDefaultTabTextColor(int color) {
        tabViewTextColorsDefault = ColorStateList.valueOf(color);
    }

    public void setSelectedTabTextColor(int color) {
        tabViewTextColorsSelected = ColorStateList.valueOf(color);
    }
    ...
    public void setDefaultTabTextColor(ColorStateList colors) {
        tabViewTextColorsDefault = colors;
    }

    public void setSelectedTabTextColor(ColorStateList colors) {
        tabViewTextColorsSelected = colors;
    }
    ...
    protected TextView createDefaultTabView(CharSequence title) {
        ...
        textView.setTextColor(tabViewTextColorsDefault);
        ...
        for (int i = 0; i < adapter.getCount(); i++) {
            ...
            if (i == viewPager.getCurrentItem()) {
                ...
                if (tabView instanceof TextView) {
                    ((TextView) tabView).setTextColor(tabViewTextColorsSelected);
                    ((TextView) tabView).setTypeface(Typeface.DEFAULT_BOLD);
                }
            }
        }
    }
    ...
    public void setPageAnimClose(boolean b) {
        this.pageAnimClose = b;
    }
     ...
     * {@link #setCustomTabView(com.me.fanyin.zbme.widget.smarttablayout.SmartTabLayout.TabProvider)}
     */
            ...
            for (int i = 0, size = tabStrip.getChildCount(); i < size; i++) {
                ...
                if (position == i) {
                    if (tabStrip.getChildAt(i) instanceof TextView) {
                        ((TextView) tabStrip.getChildAt(i)).setTextColor(tabViewTextColorsSelected);
                        ((TextView) tabStrip.getChildAt(i)).setTypeface(Typeface.DEFAULT_BOLD);
                    }
                } else {
                    if (tabStrip.getChildAt(i) instanceof TextView) {
                        ((TextView) tabStrip.getChildAt(i)).setTextColor(tabViewTextColorsDefault);
                        ((TextView) tabStrip.getChildAt(i)).setTypeface(Typeface.DEFAULT);
                    }
                }
            }
    ...
    public void updateTitle() {
        ...
        for (int i = 0; i < childCount; i++) {
            ...
            if (tabStrip.getChildAt(i) instanceof TextView) {
                TextView childAt = (TextView) tabStrip.getChildAt(i);
                CharSequence ordTitle = childAt.getText();
                CharSequence title = viewPager.getAdapter().getPageTitle(i);
                childAt.setText(title);
                if (ordTitle.length() != title.length()) {
